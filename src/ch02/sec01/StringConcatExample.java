...
public class StringConcatExample {
    public static void main(String[] args){
        ...
        System.out.println("result2: " + (10 + 2 + "8")); //꼰대 입장에서 12/8 보이기에 128
        System.out.println("result3: " + (10 + "2" + 8)); // 10/2/8 문자열과 숫자가 만나면 무조건 문자열
        ...
        // Wrapper 클래스 (Integer, Double, Float 등등)
